...
Use the mask map to guide the linguistic learning in the vision model. Download (our trained [vision+MLM (BaiduYun)](https://pan.baidu.com/s/1zv-kKZGREjScW6p2dSwcXw) (password:04jg) or [RuiKe](https://rec.ustc.edu.cn/share/84a19b50-28c5-11ec-87c6-35ad826f4060) (password:v67q)), rename it as best_acc_M.pth and put it in /output/LF_2/best_acc_M.pth.
